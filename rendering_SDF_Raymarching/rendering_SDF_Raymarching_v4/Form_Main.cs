            ...
            for (int i = 0; i < wMap; i++)
            {
                for (int j = 0; j < hMap; j++)
                {
                    ...
                    if (objects.Count > 0)
                    {
                        ...
                        else if (d <= objects[o].r + light)
                        {
                            if (objects[o].id == 1)
                            {
                                //cA = /*(byte)d*/rnd.Next((int)d); cR = 255; cG = 0; cB = 0;
                                cA = /*(byte)d*/rnd.Next(255); cR = 255; cG = 0; cB = 0;
                            }
                            else if (objects[o].id == 2)
                            {
                                //cA = /*(byte)d*/rnd.Next((int)d); cR = 0; cG = 0; cB = 255;
                                cA = /*(byte)d*/rnd.Next(255); cR = 0; cG = 0; cB = 255;
                            }
                            else
                            {
                                //cA = /*(byte)d*/rnd.Next((int)d); cR = 255; cG = 255; cB = 0;
                                cA = /*(byte)d*/rnd.Next(255); cR = 255; cG = 255; cB = 0;
                            }
                        }
